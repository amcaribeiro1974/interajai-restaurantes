  ...
  return (
    <button
      className={cn(
        ...
        {
          'bg-interaj-600 text-white hover:bg-interaj-700 active:bg-interaj-800': variant === 'primary',
          'bg-secondary text-interaj-800 hover:bg-secondary/80 active:bg-secondary/90': variant === 'secondary',
